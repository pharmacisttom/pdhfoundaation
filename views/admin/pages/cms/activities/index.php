...
<td><?php echo htmlspecialchars($item['date']); ?></td>
                    ...
                    <td class="text-end">
                        ...
                        <form action="<?php echo $_ENV['APP_URL']; ?>/admin/cms/activities/delete" method="POST" class="d-inline delete-form">
...
<div class="modal fade" id="formModal" tabindex="-1">
    <div class="modal-dialog">
        <div class="modal-content rounded-4 border-0 shadow">
            <form action="<?php echo $_ENV['APP_URL']; ?>/admin/cms/activities/store" method="POST">
                <?php echo \App\Helpers\CSRF::field(); ?>
