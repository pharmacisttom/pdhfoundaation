<div class="d-flex justify-content-between align-items-center mb-4">
    <h4 class="fw-bold mb-0"><i class="fa-solid fa-diagram-project text-primary me-2"></i> <?php echo $data['page_title']; ?></h4>
...
<th>สถานะ</th>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td><?php echo htmlspecialchars($item['project_code']); ?></td>
...
<td><?php echo htmlspecialchars($item['status']); ?></td>
                    ...
                    <td class="text-end">
                        ...
                        <form action="<?php echo $_ENV['APP_URL']; ?>/admin/finance/projects/delete" method="POST" class="d-inline delete-form">
...
<div class="modal fade" id="formModal" tabindex="-1">
    <div class="modal-dialog">
        <div class="modal-content rounded-4 border-0 shadow">
            <form action="<?php echo $_ENV['APP_URL']; ?>/admin/finance/projects/store" method="POST">
                <?php echo \App\Helpers\CSRF::field(); ?>
