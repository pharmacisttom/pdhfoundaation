...
class DashboardController extends Controller
{
    ...
    public function index()
    {
        ...
        $totalRevenue = $db->query("SELECT SUM(amount) FROM fund_transactions WHERE transaction_type = 'DONATION' OR transaction_type = 'REVENUE'")->fetchColumn() ?: 0;
        $totalExpense = $db->query("SELECT SUM(amount) FROM fund_transactions WHERE transaction_type = 'EXPENSE'")->fetchColumn() ?: 0;
